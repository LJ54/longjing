...
gridContainer.addEventListener("mouseenter", () => {
  gridContainer.style.outline = "1px solid blue";
...
//    cell.style.outline = "1px solid red";
      ...
      this.outerText = "The exchange program in UVic and the Bodwell program show me what it is like stepping out of my comfort zone.";
  });
  ...
  cell.addEventListener("click", function () {
    if (cell.style.backgroundColor) {
      ...
      cell.style.backgroundColor = `#${randColor()}`;
      this.innerText = "The exchange program in UVic and the Bodwell program show me what it is like stepping out of my comfort zone."
    }
  });
});
